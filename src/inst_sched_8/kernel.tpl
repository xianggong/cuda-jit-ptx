...
entry:
  ...
  %id_base_1 = add i32 %id_base, %tid

  %ptrStride = getelementptr i32 addrspace(1)* %Stride, i32 0
  %id_stride = load i32 addrspace(1)* %ptrStride, align 4
  %id = mul i32 %id_base_1, %id_stride
