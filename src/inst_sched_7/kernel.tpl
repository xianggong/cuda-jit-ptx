...
entry:
  ...
  %ptrOffset = getelementptr i32 addrspace(1)* %Offset, i32 0
  %id_offset = load i32 addrspace(1)* %ptrOffset, align 4
  %id = add i32 %id_base_1, %id_offset
